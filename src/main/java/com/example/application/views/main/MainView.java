...
import com.example.application.views.doctorlist.DoctorListView;
import com.example.application.views.patientlist.PatientListView;
import com.example.application.views.prescriptionlist.PrescriptionListView;
...
public class MainView extends AppLayout {
    ...
    private Component[] createMenuItems() {
        RouterLink[] links = new RouterLink[]{
                new RouterLink("Patient List", PatientListView.class),
                new RouterLink("Doctor List", DoctorListView.class),
                new RouterLink("Prescription List", PrescriptionListView.class)
        };
